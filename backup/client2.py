...
class client:
    ...
    def download(self, input_command, file_str):
        if input_command[1] == "TCP":
            ...
            try:
                ...
                print(
                    "TCP: Insufficient read permissions. Unable to access file {}"
            ...
            print(
                "The filesize and hash of the file {} is {} and {} , last modified on"
                " {} {} {}.".format(
                    filename,
                    filesize,
                    file_metadata[3],
            ...
            if file_hash == udp_hash:
                ...
                filename = input_command[2]
                print(
                    "The filesize and hash of the file {} is {} and {} , last modified"
                    " on {} {} {}.".format(
                        filename,
                        filesize,
                        file_metadata[3],
    ...
    def hash(self, input_command):
        ...
        if input_command[1] == "verify":
            ...
            if cli_output == 'WRONG':
                print(
                    "hash <verify>: File do not exist!!. Enter the correct file"
                    " name/path"
                )
                return
            ...
            print(
                "The hash of the file {} is {} , last modified on {} {} {}.".format(
                    filename, cli_output[3], cli_output[0], cli_output[1], cli_output[2]
                )
            )
            # print(cli_output)
            cli_socket.close()
            ...
            cli_output = cli_output.split("\n")
            print(
                "|            Filename            | Last Modified Time |            Md5"
                " Checksum            |\n"
            )
            for i in cli_output:
                if i.strip() == "":
    ...
    def index(self, input_command):
        ...
        for i in cli_output:
            ...
            print(
                ...
                temp[0],
                "     | ",
                humanize.naturalsize(int(temp[1])),
                " |     ",
                temp[2],
                "     |              ",
                temp[3],
